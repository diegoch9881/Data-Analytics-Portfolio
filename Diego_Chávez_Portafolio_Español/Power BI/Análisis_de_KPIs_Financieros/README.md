...
👉 **[Ver Reporte Interactivo en Power BI Service](https://app.powerbi.com/view?r=eyJrIjoiYzZkZTViOTAtZDlhMy00MzQ1LTk5MjAtMjVhMjgxZWJjNjg0IiwidCI6ImM2MjU5ZjJlLTg2YTAtNDI2Yi05NWUwLTZjZTMzY2FlMTc1ZiIsImMiOjR9&embedImagePlaceholder=true&pageName=ReportSectione09619d7b535813fae37)**
...
1. **Optimizar Balances de Ingresos vs. Gastos:** Identificar tendencias de rentabilidad y excesos de costos.
2. **Mejorar la Asignación de Recursos:** Brindar visibilidad sobre el gasto departamental para respaldar mejores decisiones presupuestarias.
3. **Proyecciones Estratégicas:** Utilizar datos históricos para visualizar el rendimiento fiscal a lo largo del tiempo.
...
* **Arquitectura de Esquema en Estrella (Star Schema):** Diseño de un modelo de datos limpio con tablas de Hechos y Dimensiones dedicadas para asegurar un alto rendimiento y escalabilidad.
